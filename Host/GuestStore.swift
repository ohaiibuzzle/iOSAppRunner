...
enum GuestStore {
    ...
    static func convert(bundleURL: URL, importFeatures: [String: Bool]) throws {
        ...
        c_stripXattrsRecursive(bundleURL.path)
        ...
        writeRunnerFeatures(in: bundleURL, importFeatures: importFeatures)
    ...
    // MARK: - Conversion internals (private)
    ...
    private static func writeRunnerFeatures(in bundleURL: URL, importFeatures: [String: Bool]) {
